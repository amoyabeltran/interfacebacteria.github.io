...
df=pd.read_csv(RAW_DIR / 'taxonomy_complete.csv')
...
def graficoHost():
    df_graph=pd.read_csv(RAW_DIR / 'host_data.csv')
...
def treemapgraph():
    df = pd.read_csv(PROCESSED_DIR / "animals.csv")
    df1 = pd.read_csv(PROCESSED_DIR / 'human.csv')
    df2 = pd.read_csv(PROCESSED_DIR / 'environmental.csv')
    df3 = pd.read_csv(PROCESSED_DIR / 'biology.csv')
    df4 = pd.read_csv(PROCESSED_DIR / 'vegetation.csv')
    df['host'] = 'animals'
    df1['host'] = 'human'
    df2['host'] = 'ambiental'
    df3['host'] = 'biologico'
...
def graficoVarGen():
    ...
    df = pd.read_csv(MATRICES_DIR / 'matrix_identity_abio.csv')
    df2 = pd.read_csv(PROCESSED_DIR / "animals.csv")
    df3 = pd.read_csv(PROCESSED_DIR / "human.csv")
